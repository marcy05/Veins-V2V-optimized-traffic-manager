...
#include "veins/modules/application/optimization/hexManagement.h"
...
class BaseWaveApplLayer : public BaseApplLayer, public VehicleData {
    ...
    protected:
        ...
        /**  @ THIS FUNCTION IS CALLED IN TaCIDemo11p EACH TIME A BEACON IS RECEIVED*/
