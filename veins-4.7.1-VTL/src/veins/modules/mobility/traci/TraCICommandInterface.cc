...
int TraCICommandInterface::Vehicle::getSignal(){
    return traci->genericGetInt(CMD_GET_VEHICLE_VARIABLE, nodeId, VAR_SIGNALS, RESPONSE_GET_VEHICLE_VARIABLE);
}
...
void TraCICommandInterface::Vehicle::stopAt(std::string roadId, double lanePosition, uint8_t laneid, double radius, double waittime) {
